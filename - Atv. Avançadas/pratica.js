...
// **Avançado** - Este exercício combina praticamente todos os conceitos estudados e exige pensamento computacional complexo.
...
// - Arrays de objetos
// - Métodos de arrays: push, pop, shift, unshift, splice, slice
// - Métodos de busca: indexOf, find, filter
// - Métodos de iteração: forEach, map, reduce
// - Ordenação: sort
// - Objetos literais
...
// - Métodos: toUpperCase, toLowerCase, trim, split, replace, substring, includes
// - Concatenação
// - Template literals
...
// - Conversão de tipos (Number, parseInt, parseFloat)
// - Formatação de saída (toFixed)
...
// Este exercício integrará **todos os conceitos** que você estudou no repositório e exigirá que você pense como um desenvolvedor profissional, criando um sistema completo, funcional e bem-organizado.
